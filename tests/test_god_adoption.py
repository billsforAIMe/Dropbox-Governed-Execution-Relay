...
class T(unittest.TestCase):
 ...
 def test_health_binding(self):
  s=(ROOT/"src/dger/relay.py").read_text(); self.assertNotIn('"dger_commit":',s); self.assertNotIn('"dger_tree":',s); self.assertIn('"dger_resident_surface_sha256": surface_sha',s); self.assertIn('"dger_resident_surface": surface_rows',s)
