...
adapter_spec=importlib.util.spec_from_file_location("dger_god_adapter_c7r",ROOT/"deployment/dger_god_adapter.py")
...
relay_spec=importlib.util.spec_from_file_location("dger_relay_c7r",ROOT/"src/dger/relay.py")
...
class C7RIdentityTests(unittest.TestCase):
