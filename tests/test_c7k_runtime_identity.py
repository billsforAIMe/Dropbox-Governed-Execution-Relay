...
adapter_spec=importlib.util.spec_from_file_location("dger_god_adapter_c7k",ROOT/"deployment/dger_god_adapter.py")
...
relay_spec=importlib.util.spec_from_file_location("dger_relay_c7k",ROOT/"src/dger/relay.py")
...
class C7KIdentityTests(unittest.TestCase):
