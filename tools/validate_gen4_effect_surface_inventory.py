...
REQUIRED_IDS = {
    ...
    "gen3-launcher", "gen4-library-relay", "gen4-moh-effect-port", "gen4-ahc-effect-port",
...
def main() -> int:
    ...
    for fn in {"_write_pre_ahc_wal", "_begin_ahc", "_status_before_execute", "_execute_moh", "_reconcile_moh", "_accept_ahc_terminal", "_publish_chm"}:
