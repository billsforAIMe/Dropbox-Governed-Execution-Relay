...
CANDIDATE='ac42596b97d39153ffc9f77fb51fe1648b30f591'
TREE='d2027676989473584ac9ec2a43dff179163eb7ee'
...
echo "EXPECTED_CANDIDATE=$CANDIDATE"
echo "EXPECTED_TREE=$TREE"
...
OBS_CAND="$(/usr/bin/git -C "$WORK/repo" rev-parse refs/remotes/origin/candidate)"
[ "$OBS_MAIN" = "$MAIN" ] || { echo "DGER_MAIN_MOVED_REASSESS observed=$OBS_MAIN"; exit 75; }
[ "$OBS_CAND" = "$CANDIDATE" ] || { echo "DGER_CANDIDATE_MOVED_REASSESS observed=$OBS_CAND"; exit 75; }
OBS_TREE="$(/usr/bin/git -C "$WORK/repo" rev-parse "$OBS_CAND^{tree}")"
...
echo "OBSERVED_CANDIDATE=$OBS_CAND"
echo "OBSERVED_TREE=$OBS_TREE"
echo 'IDENTITY_ANCESTRY_DIFF=PASS'
